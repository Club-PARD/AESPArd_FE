...
class SmallCircularProgressBar: UIView {
    
    var lineWidth: CGFloat = 7  // 프로그래스 바의 두께
    ...
    override func draw(_ rect: CGRect) {
        ...
        // 원의 반지름을 30px로 설정 (60px / 2) - lineWidth / 2
    ...
    func setProgress(_ rect: CGRect) {
        ...
        //30은 원의 반지름
        bezierPath.addArc(withCenter: CGPoint(x: 30, y: 30),
                          radius: 30 - lineWidth / 2,
                          startAngle: -.pi / 2,
