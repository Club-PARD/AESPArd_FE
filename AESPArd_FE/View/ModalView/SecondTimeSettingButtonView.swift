...
class SecondTimePickerInputView: UIView, UITextFieldDelegate {
    ...
    // 필드모드로 바꾸는 함수 -> 버튼에서 시간을 넣을 수 있게 함
    ...
    // 필드 모드에서 시간을 입력하면 입력한 시간을 갖고 버튼 텍스트에 가져가 업데이트함
